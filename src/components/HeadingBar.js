...
function HeadingBar() {
    return(
        <div id="banner" tabIndex="-1" className="z-50 sticky top-0 flex justify-center w-full px-4 py-3 border border-b border-gray-200 bg-cyan-300 dark:border-gray-600 lg:py-4 dark:bg-gray-700">
